...
(() => {
  ...
  const stylesheet =
    ...
    ':host([compact]) .empty .cap{font-size:9px;line-height:1.3}' +
    ':host([caption-top]) .empty{justify-content:flex-start;padding-top:16px}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">ou <u>escolha um arquivo</u></div></div>' +
